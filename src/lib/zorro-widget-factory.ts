...
import { UIGridModule } from '../app/shared/components/yzt-grid/yzt-grid.component';
...
export class ZorroWidgetFactory {
    ...
    public createTableComponent(container: ViewContainerRef, template: string, properties: any = {}, context: any) {
        ...
        @NgModule({
            declarations: [TemplateComponent],
            imports: [CommonModule, FormsModule, ReactiveFormsModule, NgZorroAntdModule, UIGridModule,],
            providers: [ActionRegistry]
        })
        class TemplateModule { }
    ...
    /* yapi yzt-grid */
    public createYztGridComponent(container: ViewContainerRef, template: string, properties: any = {}, context: any) {
