...
export class ZorroFormComponent implements AfterViewInit, OnDestroy {
        ...
        switch (type) {
            case 'horizontal-layout':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('horizontalMockData'),
                    null,
                    4
                );
                break;
            case 'vertical-layout':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('verticalMockData'),
                    null,
                    4
                );
                break;
            case 'register-form':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('registerFormMockData'),
                    null,
                    4
                );
                break;
            ...
            case 'layout':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('zorroGridMockData'),
                    null,
                    4
                );
                break;
            case 'table':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('tableMockData'),
                    null,
                    4
                );
                break;
            case 'full':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('zorroFullWidgetMockData'),
                    null,
                    4
                );
                break;
            case 'yapi':
                ...
                this.schemaString = JSON.stringify(
                    this.service.getData('yapiMockData'),
                    null,
                    4
                );
                break;
    ...
    onBuilderFinish($event) {
        ...
        this.log(
            `build success，${this.builderInfo._endTime -
    ...
    copyCode(type?: number, codeType?: string) {
        ...
        if (type === 1) {
            if ('download' in document.createElement('a')) {
                funDownload(
                    flag ? this.componentCode : this.htmlCode,
                    flag
                        ? this.fileNames.compFileName
                        : this.fileNames.htmlFileName
                );
            } else {
